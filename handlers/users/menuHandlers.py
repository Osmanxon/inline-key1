...
from keyboards.inline.productsKeyboard import categoryMenu, coursesMenu, booksMenu, telegram_keyboard, algorithm_keyboard
...
async def select_category(message: Message):
    ...
    logging.info(f"Username: {message.from_user.full_name=}")
    logging.info(f"To'liq ismi: {message.from_user.full_name=}")
