...
categoryMenu=InlineKeyboardMarkup(
    inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text="🔗 Jonibekdev sahifasiga o'tish", url="https://jonibekdev.netlify.app"),
        ],
        [
...
telegram_keyboard=InlineKeyboardMarkup(inline_keyboard=[
    [
        InlineKeyboardButton(text="Xarid qilish", url="https://jonibekdev.netlify.app")
    ]
])

algorithm_keyboard=InlineKeyboardMarkup(inline_keyboard=[
    [
        InlineKeyboardButton(text="Ko'rish", url="https://jonibekdev.netlify.app")
    ]
])